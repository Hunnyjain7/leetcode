...
class Solution:
    def kidsWithCandies(self, candies: List[int], extraCandies: int) -> List[bool]:  # noqa
        max_candies = max(candies)
        return list(map(lambda i: True if (i + extraCandies) >= max_candies else False, candies))
